            ...
            <Container className='mt-5'>
                {!send?<>
                    <div className='App'>
                        ...
                        </Alert><div><Button variant='info' onClick={resendVerifyMail}>Resend Verification Mail</Button></div></>:<><div><Alert variant='success'><h1 className='text-center text-success'>Email verified Successfully</h1><hr/><Link to="/"><h3 className='text-center'>Click to Login</h3></Link></Alert></div></>}
                </div></>:<><div className='App'><Alert variant='success'><div className='text-center'><h1 className='text-primary'>You Will automatically redirected to verify yourself page.</h1></div></Alert></div></>}
